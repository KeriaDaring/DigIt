    ...
    def on_event(
        ...
        if dora_event["type"] == "INPUT":
            ...
            if dora_event["id"] in agent_inputs:
                ...
                yaml_file_path = get_relative_path(current_file=__file__, sibling_directory_name='configs', target_file_name='beaufy-context.yml')
                inputs = load_agent_config(yaml_file_path)
                inputs['input_fields'] = {'beauty_context':task}
                ...
                send_output("beauty_context_output", pa.array([create_agent_output(agent_name='beauty-context', agent_result=agent_result, dataflow_status=os.getenv('IS_DATAFLOW_END', True))]), dora_event['metadata'])
